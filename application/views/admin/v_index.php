...
<img src="<?php echo base_url().'assets/img/bg2.jpg'?>" alt="gambar" class="bg" />
   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" style="color:#ff0000;">Selamat Datang
                    <small>di Aplikasi Point of Sales</small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
	<div class="mainbody-section text-center">
     ...
     <?php $u=$this->session->userdata('user'); ?>
                ...
                <div class="menu-item blue" style="height:150px;">
                     <a href="<?php echo base_url().'admin/penjualan'?>" data-toggle="modal">
                           <i class="fa fa-shopping-bag"></i>
                            <p style="text-align:left;font-size:14px;padding-left:5px;">Penjualan POS</p>
                      </a>
                </div> 
            </div>
            <div class="col-md-3 portfolio-item">
        ...
        <?php if($h=='1'){ ?> 
            ...
            <div class="col-md-3 portfolio-item">
                <div class="menu-item blue" style="height:150px;">
                     <a href="<?php echo base_url().'admin/Barang_kain'?>" data-toggle="modal">
                           <i class="fa fa-shopping-cart"></i>
                            <p style="text-align:left;font-size:14px;padding-left:5px;">Barang Kain</p>
                      </a>
                </div> 
            </div>
            <div class="col-md-3 portfolio-item">
