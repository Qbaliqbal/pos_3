...
<head>
    ...
    <meta name="description" content="Produk By Qbal Industries">
    <meta name="author" content="Riyandi M.Iqbal">

    <title>Management Data Barang Kain</title>
    ...
    <div class="container">
        ...
        <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel">Tambah Kain</h3>
            </div>
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang_kain/tambah_barang'?>">
        ...
        <?php
                ...
                <div id="modalEditPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang_kain/edit_barang'?>">
                        <div class="modal-body">
        ...
        <?php
                ...
                <div id="modalHapusPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang_kain/hapus_barang'?>">
                        <div class="modal-body">
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo '2019';?> by Q.I</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
