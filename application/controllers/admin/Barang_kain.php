<?php
class Barang_kain extends CI_Controller{
	...
	if($this->session->userdata('akses')=='1'){
		$data['data']=$this->m_barang->tampil_barang_kain();
		$data['kat']=$this->m_barang->tampil_kategori_kain();
		$data['kat2']=$this->m_barang->tampil_kategori_kain();
		$this->load->view('admin/v_barang_kain',$data);
	}else{
